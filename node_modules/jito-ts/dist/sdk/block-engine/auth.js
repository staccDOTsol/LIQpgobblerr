...
class AuthProvider {
    ...
    injectAccessToken(callback, errorCallback) {
        var _a;
        if (!this.accessToken ||
            !this.refreshToken ||
    ...
    async refreshAccessToken() {
        return new Promise((resolve) => {
            ...
            this.client.refreshAccessToken({
                ...
                this.accessToken = new Jwt(((_a = resp.accessToken) === null || _a === void 0 ? void 0 : _a.value) || '', (0, utils_1.unixTimestampFromDate)(((_b = resp.accessToken) === null || _b === void 0 ? void 0 : _b.expiresAtUtc) || new Date()));
                resolve({ success: true });
            });
        });
    }
    // Creates an AuthProvider object, and asynchronously performs full authentication flow.
    static create(client, authKeypair) {
        const provider = new AuthProvider(client, authKeypair);
        provider.fullAuth((accessToken, refreshToken) => {
